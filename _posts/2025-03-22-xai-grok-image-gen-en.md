...
According to xAI's documentation [Image Generations - Guides | xAI Docs](https://docs.x.ai/docs/guides/image-generations), the API style of grok-2-image is consistent with OpenAI, so owui should be able to use xAI's API directly, right?
