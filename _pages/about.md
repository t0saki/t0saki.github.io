...
Driven by passion, I started programming at a young age and often keep myself updated by reading various tech news and articles, which has honed my strong sensitivity to industry trends. One of my hobbies is self-hosting various services, such as NAS, VPS, and serverless architectures. You can view the [hardware configuration table](https://va6aevvtfli.feishu.cn/docx/M7qnduKszotPUZxlRZzcIOiJnTe) of my HomeLab, check out live server monitoring on my [Dashboard](https://nezha.sakiko.us.kg/), or browse some of my publicly available services via my [Project Navigation](navigation/).
