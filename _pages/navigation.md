...
| --- | --- | --- |
| My Server Status Monitoring | [tosaki Dashboard](https://nezha.tosaki.top/) | Monitor server running status |
| Personal LLM Chat Station | [Open Chat](https://chat.tosaki.top/) | Chat using LLM, contact me for trial |
| Image Hosting | [Image Server](https://bed.tosaki.top/) | Upload images and get image links, default password: StayLegalNoAbuse |
| Short Link Generation Service | [Short Link](https://s.tosaki.top/) | Shorten links |
